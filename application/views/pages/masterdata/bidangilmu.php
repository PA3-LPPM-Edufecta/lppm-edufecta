    ...
    <div class="card card-primary">
        ...
        <div class="card-body" style="display: block;">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <a href="<?php echo base_url('dashboard/bidangilmutambah') ?>" class="btn btn-danger mb-2">Tambah Data</a>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                                        <li><a href="<?php echo base_url('dashboard/subbidangilmu') ?>" class="dropdown-item">Lihat Sub Bidang Ilmu</a></li>
