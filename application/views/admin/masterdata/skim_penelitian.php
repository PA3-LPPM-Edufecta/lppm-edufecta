			...
			<div class="col-12">
				<div class="card">
					<div class="card-header bg-light elevation-1"">
						<h3 class="card-title mt-1"><i class="fa fa-list text-blue"></i> Data Skim Penelitian</h3>
						<!-- Card-Tools -->
					...
					<div class="card-body">
						<div class="text-left mb-5">
							<button type="button" class="btn btn-primary" onclick="add_skim_penelitian()" title="Add Data"><i class="fas fa-plus"></i> Tambah Data</button>
						</div>
					...
					"render": function(data, type, row) {
						...
						if(row[7]==0){
							return `
								...
								<li><a href="javascript:void(0)" class="dropdown-item text-center" title="Edit" data-role="edit" onclick="edit_skim_penelitian(`+row[8]+`)">Edit</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item text-center" title="Delete" nama=" + row[0] + "  onclick="delskimpenelitian(`+row[8]+`)">Hapus</a></li>
