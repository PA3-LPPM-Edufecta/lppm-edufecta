			...
			<div class="col-12">
				<div class="card">
					<div class="card-header bg-light">
						<h3 class="card-title mt-1"><i class="<?php echo $this->db->get('tbl_submenu')->row(6)->icon; ?> text-blue"></i> Data Sub Bidang Ilmu</h3>
						<!-- Card-Tools -->
					...
					<div class="card-body">
						<div class="text-left mb-4">
							<button type="button" class="btn btn-sm btn-outline-primary" onclick="add_sub_bidang_ilmu()" title="Add Data"><i class="fas fa-plus"></i> Add</button>
						</div>
					...
					"render": function(data, type, row) {
						...
						if(row[4]==0){
							return `
								...
								<li><a href="javascript:void(0)" class="dropdown-item" title="Edit" data-role="edit" onclick="edit_sub_bidang_ilmu(`+row[5]+`)">Edit</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item" title="Delete" nama=" + row[0] + "  onclick="delsubbidangilmu(`+row[5]+`)">Hapus</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item" title="Delete" onclick="update_status(`+row[5]+`,` +row[4]+`)">Set Status Aktif</a></li>
								</ul>
							`;
						} else {
							return `
								...
								<li><a href="javascript:void(0)" class="dropdown-item" title="Edit" data-role="edit" onclick="edit_sub_bidang_ilmu(`+row[5]+`)">Edit</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item" title="Delete" nama=" + row[0] + "  onclick="delsubbidangilmu(`+row[5]+`)">Hapus</a></li>
								<li><a href="javascript:void(0)" class="dropdown-item" title="Delete" onclick="update_status(`+row[5]+`,` +row[4]+`)">Set Status Tidak Aktif</a></li>
								</ul>
							`;
						}
