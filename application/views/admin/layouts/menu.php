...
?>
<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-default navbar-dark navbar-blue">
  <!-- Left navbar links -->
  <ul class="navbar-nav">
    <li class="nav-item">
      ...
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        ?>
            <li class="nav-item has-treeview <?= $this->uri->segment(1) == $link ? 'menu-open' : '' ?>">
              ...
              <a href="<?= $main->link; ?>" <?= $this->uri->segment(1) == $link ? 'class="nav-link active bg-blue"' : 'class="nav-link"' ?>>
              ...
              <ul class="nav-header nav-treeview ml-2 pr-4 ">
                <?php foreach ($sub_menu->result() as $sub) : ?>
                  <li class="nav-item">
                    <a href="<?= $sub->link; ?>" <?= $this->uri->segment(1) == $sub->link ? 'class="nav-link active bg"' : 'class="nav-link"' ?>>
        ...
        <li class="nav-item">
          <hr class="form-inline bg-secondary">
