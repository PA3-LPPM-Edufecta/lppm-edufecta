    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body login-card-body">
        <form action="" role="form" id="quickForm" method="post">
          ...
          <div class="input-group mb-3 kosong">
            <input type="password" name="password" class="form-control" id="myInput" placeholder="Password" value="<?php echo set_value('password'); ?>">
            <div class="input-group-append">
              <div class="input-group-text">
          ...
          <!-- /.col -->
          <div class="center">
            <button type="submit" id="login" class="btn btn-primary btn-block"><span class="fa fa-sign-in-alt"></span> Sign In</button>
          </div>
          <!-- /.col -->
          <!-- </div> -->
          <center class="mt-3"><a href="<?php echo base_url('home'); ?>">Back to Home</a></center>
        </form>
      </div>
      <!-- <div class="col-md-12">      
        <?php
