			...
			<div class="col-12">
				<div class="card">
					<div class="card-header bg-light">
						<h3 class="card-title mt-1"><i class="<?php echo $this->db->get('tbl_submenu')->row(6)->icon; ?> text-blue"></i> Data HKI</h3>
						<!-- Card-Tools -->
					...
					<div class="card-body">
						...
						<table id="tbl_buku" class="table table-bordered table-striped table-hover">
							...
							<tr>
									...
									<td>
										<p>Dede Ropik yunus</p>
										<p>NIDN:04133017402</p>
									</td>
									<td>DASAR DASAR PENDIDIKAN AGAMA ISLAM</td>
									<td>
										<p>Penerbit:Pelangi Press Bandung</p>
										<p>ISBN:978-602-95535-7,4</p>
										<p>Jmlh.Halaman:258</p>
									</td>
									<td>
										<p>
											Cover: <a href="">Download</a><br>
											Editorial Board: <a href="">Download</a><br>
											Penerbit: <a href="">Download</a>
										</p>

										<p>File Lain:<br>
											<a href="">bukuajar-penerbit-355-1-editor.pdf</a>
										</p>
									</td>	
									<td>
