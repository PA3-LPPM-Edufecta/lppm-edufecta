				...
				<div class="card">
					<div class="card-header bg-light elevation-1"">
						...
						<div class="card-tools">
							<button type="button" class="btn btn-tool text-blue" data-card-widget="card-refresh" data-source="/lppm/publikasi_jurnal_penelitian" data-source-selector="#card-refresh-content" data-load-on-init="false">
...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		table = $("#tbl_pubjurnal").DataTable({
			...
			"ajax": {
				"url": "<?php echo site_url('publikasi_jurnal_penelitian/ajax_list') ?>",
				"type": "POST"
			},
	...
	function vpubjurnal(id) {
		...
		$.ajax({
			url: '<?php echo base_url('publikasi_jurnal_penelitian/viewjurnal'); ?>',
			type: 'post',
	...
	function deljurnal(id) {
		Swal.fire({
			...
			if (result.value) {
				$.ajax({
					url: "<?php echo site_url('publikasi_jurnal_penelitian/delete'); ?>",
					type: "POST",
					data: "id=" + id,
					cache: false,
					dataType: 'json',
	...
	function update_status(id, status) {
		$.ajax({
			url: "<?php echo site_url('publikasi_jurnal_penelitian/update_status'); ?>",
			type: "POST",
			data: {
				id: id,
				status: status
	...
	function edit_publikasi_jurnal(id) {
		...
		$.ajax({
			url: "<?php echo site_url('publikasi_jurnal_penelitian/edit_publikasi_jurnal') ?>/" + id,
			type: "GET",
			dataType: "JSON",
			success: function(data) {
	...
	function save() {
		...
		if (save_method == 'add') {
			url = "<?php echo site_url('publikasi_jurnal_penelitian/insert') ?>";
		} else {
			url = "<?php echo site_url('publikasi_jurnal_penelitian/update') ?>";
		}
				...
				<form action="#" id="form" class="form-horizontal">
					...
					<div class="card-body">
						<div class="form-group row">
							<label for="id_menu" class="col-sm-3 col-form-label">Data Publikasi Jurnal</label>
							<div class="col-sm-9 kosong">
								<select class="form-control" name="id_dosen" id="id_dosen">
									<option value="" selected disabled>Pilih Data Publikasi Jurnal</option>
									<?php
