          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header bg-light elevation-1"">
                <h3 class="card-title mt-1"><i class="fa fa-list text-blue"></i> Data Menu</h3>
                <!-- Card-Tools -->
              ...
              <div class="card-body">
                ...
                <div class="text-left mb-5">
                  <button type="button" class="btn btn-primary" onclick="add_menu()" title="Add Data"><i class="fas fa-plus"></i> Tambah Data</button>
                </div>
          ...
          "columnDefs": [{
            ...
            "render": function(data, type, row) {
              ...
              return `
                    ...
                    <li><a href="javascript:void(0)" class="dropdown-item text-center" title="Edit" data-role="edit" onclick="edit_menu(` + row[5] + `)">Edit</a></li>
                    <li><a href="javascript:void(0)" class="dropdown-item text-center" title="Delete" nama=" + row[0] + "  onclick="delmenu(` + row[5] + `)">Hapus</a></li>
                  </ul>
							`;
              } else {
                return `
