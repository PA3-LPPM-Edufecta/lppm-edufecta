            ...
            <div class="card">
              <div class="card-header bg-light">
                ...
                <div class="card-tools">
                  <button type="button" class="btn btn-tool text-blue" data-card-widget="card-refresh" data-source="/lppm/userlevel" data-source-selector="#card-refresh-content" data-load-on-init="false">
