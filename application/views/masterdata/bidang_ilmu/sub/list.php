<!-- <?php echo form_open(base_url('sub_bidang_ilmu/proses')); ?>
<p class="btn-group">
    <a href="<?php echo base_url('sub_bidang_ilmu/tambah') ?>" class="btn btn-success btn-lg">
        <i class="fa fa-plus"></i> Tambah bidang_ilmu/sub
    </a>
</p>
    ...
    <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
        ...
        <?php foreach ($sub_bidang_ilmu as $row) { ?>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url() ?>bidang_ilmu/sub/edit/<?php echo $row['id'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url() ?>bidang_ilmu/sub/delete/<?php echo $row['id'] ?>" class="btn btn-danger btn-xs" onclick="confirmation(event)"><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
    ...
    <div class="card card-primary">
        ...
        <div class="card-body" style="display: block;">
            <div class="container-fluid">
                <a href="<?php echo base_url('sub_bidang_ilmu/tambah') ?>" class="btn btn-danger mb-2">Tambah Data</a>
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                                                ...
                                                <li><a href="<?php echo base_url() ?>sub_bidang_ilmu/edit/<?php echo $row['id'] ?>" class="dropdown-item">Edit</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <form method="post" action="<?php echo base_url() ?>sub_bidang_ilmu/delete/<?php echo $row['id'] ?>">
        ...
        <div class="modal fade" id="modal-status<?php echo $row['id'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-dark" data-dismiss="modal">Tidak</button>
                        <form action="<?php echo base_url() ?>sub_bidang_ilmu/edit_status/<?php echo $row['id'] ?>" method="post">
                            <?php
                            if ($row['status'] == 1) {
