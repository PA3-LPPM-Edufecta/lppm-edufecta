  ...
  <div class="card card-primary">
    ...
    <div class="card-body" style="display: block;">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-12">
            <form method="post" action="<?php echo base_url('masterdata/sub_bidang_ilmu/edit/' . $sub_bidang_ilmu['id']) ?>">
              <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">Nama Sub Bidang Ilmu</label>
                <div class="col-sm-10">
