<!-- <?php echo form_open(base_url('pencairan/proses')); ?>
<p class="btn-group">
    <a href="<?php echo base_url('pencairan/tambah') ?>" class="btn btn-success btn-lg">
    ...
    <table id="example1" class="display table table-bordered" cellspacing="0" width="100%">
        ...
        <?php foreach ($pencairan as $row) { ?>
                <tr>
                    ...
                    <td>
                        <div class="btn-group">
                            <a href="<?php echo base_url() ?>pencairan/edit/<?php echo $row['id'] ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo base_url() ?>pencairan/delete/<?php echo $row['id'] ?>" class="btn btn-danger btn-xs" onclick="confirmation(event)"><i class="fa fa-trash-o"></i></a>
                        </div>
                    </td>
                </tr>
            <?php } ?>
    ...
    <div class="card card-primary">
        ...
        <div class="card-body" style="display: block;">
            <div class="container-fluid">
                <a href="<?php echo base_url('pencairan/tambah') ?>" class="btn btn-danger mb-2">Tambah Data</a>
                <div class="row">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                                                <li><a href="<?php echo base_url() ?>pencairan/edit/<?php echo $row['id'] ?>" class="dropdown-item">Edit</a></li>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer justify-content-between">
                        ...
                        <form method="post" action="<?php echo base_url() ?>pencairan/delete/<?php echo $row['id'] ?>">
