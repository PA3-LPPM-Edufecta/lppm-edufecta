...
<form name="form1" action="<?php echo base_url() ?>index.php/luaran/delete/<?php echo $luaran['id'] ?>" method="post" class="myform">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table">
    ...
    <tr>
      ...
      <td><input type="submit" class="btn btn-primary btn-lg"  name="submit" id="submit" value="Delete Luaran">
        ...
        <a href="<?php echo base_url() ?>index.php/luaran" class="tambah">Cancel</a></td>
    </tr>
  </table>
