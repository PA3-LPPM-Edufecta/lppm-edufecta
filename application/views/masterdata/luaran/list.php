    ...
    <div class="card card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button type="button" class="btn btn-tool" data-card-widget="card-refresh" data-source="/lppm/masterdata/luaran" data-source-selector="#card-refresh-content" data-load-on-init="false">
        ...
        <div class="card-body" style="display: block;">
            <div class="container-fluid">
                <a href="<?php echo base_url('masterdata/luaran/tambah') ?>" class="btn btn-danger mb-2">Tambah Data</a><br><br>
                <div class="row">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow" style="left: 0px; right: inherit;">
                                            <li><a href="<?php echo base_url() ?>masterdata/luaran/edit/<?php echo $row['id'] ?>" class="dropdown-item">Edit</a></li>
                                            <li><a href="<?php echo base_url() ?>masterdata/luaran/delete/<?php echo $row['id'] ?>" class="dropdown-item" onclick="confirmation(event)">Hapus</a></li>
                                            <?php
                                            if ($row['status'] == 1) {  ?>
