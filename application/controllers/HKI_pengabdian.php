...
class HKI_pengabdian extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('HKI_pengabdian_model', 'Data_dosen_model', 'Tipe_pengajuan_model'));
    }
    ...
    public function index()
    {
        ...
        $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_pengabdian/HKI_pengabdian', $data);
    }
