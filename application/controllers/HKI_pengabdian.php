...
class HKI_pengabdian extends MY_Controller
{

    public function __construct()
    {
        parent::__construct();
        $this->load->model(array('HKI_pengabdian_model', 'Data_dosen_model', 'Tipe_pengajuan_model', 'akses_model'));
    }
    ...
    public function index()
    {
        ...
        if ($view_level == 'Y') {
            return $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_pengabdian/HKI_pengabdian', $data);
        } else {
    ...
    {
        $list = $this->HKI_pengabdian_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        foreach ($list as $hki) {
            $no++;
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->HKI_pengabdian_model->count_all(),
            "recordsFiltered" => $this->HKI_pengabdian_model->count_filtered(),
            "data" => $data
        );
    ...
    //     $this->HKI_pengabdian_model->insert_hki("tbl_hki", $save);
    ...
    //     $this->HKI_pengabdian_model->update_hki($id, $save);
    ...
    public function insert()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $g = $this->HKI_pengabdian_model->getImage($id)->row_array();
    ...
    public function viewhki()
    {
        ...
        $data['data_table'] = $this->HKI_pengabdian_model->view_hki($id)->result_array();
        $this->load->view('admin/settings/view', $data);
    }

    public function edit_hki($id)
    {
        $data = $this->HKI_pengabdian_model->get_hki($id);
    ...
    public function update_status()
    {
        ...
        $this->HKI_pengabdian_model->update_hki($id, $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function delete()
    {
        ...
        $this->HKI_pengabdian_model->delete_hki($id, 'tbl_hki');
        $data['status'] = TRUE;
        echo json_encode($data);
    }
