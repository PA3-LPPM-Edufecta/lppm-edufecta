...
class Buku_ajar extends MY_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model(array('Buku_ajar_model', 'Data_dosen_model', 'Tipe_pengajuan_model'));
    }
    ...
    public function index()
    {
        ...
        $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_penelitian/buku_ajar', $data);
    }
