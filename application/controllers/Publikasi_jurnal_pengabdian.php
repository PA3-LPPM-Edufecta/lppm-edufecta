...
class Publikasi_jurnal_pengabdian extends MY_Controller
{
    ...
    {
        $list = $this->Publikasi_jurnal_pengabdian_model->get_datatables();
        $data = array();
        $no = $_POST['start'];
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Publikasi_jurnal_pengabdian_model->count_all(),
            "recordsFiltered" => $this->Publikasi_jurnal_pengabdian_model->count_filtered(),
            "data" => $data
        );
    ...
    public function insert()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $g = $this->Publikasi_jurnal_pengabdian_model->getImage($id)->row_array();
                ...
                $this->Publikasi_jurnal_pengabdian_model->insert_publikasi_jurnal("tbl_publikasi_jurnal", $save);
    ...
    public function update()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $this->Publikasi_jurnal_pengabdian_model->update_publikasi_jurnal($id, $save);
                echo json_encode(array("status" => TRUE));
            } else { //Apabila tidak ada gambar yang di upload
                $save  = array(
                    'id_dosen'              => $this->input->post('id_dosen'),
    ...
    public function viewjurnal()
    {
        ...
        $data['data_table'] = $this->Publikasi_jurnal_pengabdian_model->view_publikasi_jurnal($id)->result_array();
        $this->load->view('admin/settings/view', $data);
    }

    public function edit_publikasi_jurnal($id)
    {
        $data = $this->Publikasi_jurnal_pengabdian_model->get_publikasi_jurnal($id);
    ...
    public function update_status()
    {
        ...
        $this->Publikasi_jurnal_pengabdian_model->update_publikasi_jurnal($id, $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function delete()
    {
        ...
        $this->Publikasi_jurnal_pengabdian_model->delete_publikasi_jurnal($id, 'tbl_publikasi_jurnal');
        $data['status'] = TRUE;
        echo json_encode($data);
    }
