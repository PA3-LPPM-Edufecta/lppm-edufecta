...
class Publikasi_jurnal_penelitian extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('Publikasi_jurnal_penelitian_model', 'Data_dosen_model', 'Tipe_pengajuan_model'));
    }
    ...
    public function index()
    {
        ...
        $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_penelitian/Publikasi_jurnal_penelitian', $data);
    }
