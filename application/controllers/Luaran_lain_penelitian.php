...
class Luaran_lain_penelitian extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('Luaran_lain_penelitian_model', 'Data_dosen_model'));
    }
    ...
    public function index()
    {
        ...
        $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_penelitian/luaran_lain_penelitian', $data);
    }
