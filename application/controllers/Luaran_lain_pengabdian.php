...
class Luaran_lain_pengabdian extends MY_Controller
{
    ...
    public function ajax_list()
    {
        ...
        $output = array(
            "draw" => $_POST['draw'],
            "recordsTotal" => $this->Luaran_lain_pengabdian_model->count_all(),
            "recordsFiltered" => $this->Luaran_lain_pengabdian_model->count_filtered(),
            "data" => $data
        );
    ...
    public function insert()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $g = $this->Luaran_lain_pengabdian_model->getImage($id)->row_array();
                ...
                $this->Luaran_lain_pengabdian_model->insert_luaran("tbl_luaran_lain", $save);
    ...
    public function update()
    {
        if (!empty($_FILES['imagefile']['name'])) {
            ...
            if ($this->upload->do_upload('imagefile')) {
                ...
                $this->Luaran_lain_pengabdian_model->update_luaran($id, $save);
                echo json_encode(array("status" => TRUE));
            } else { //Apabila tidak ada gambar yang di upload
                $save  = array(
                    'id_dosen' => $this->input->post('id_dosen'),
    ...
    public function viewluaran()
    {
        ...
        $data['data_table'] = $this->Luaran_lain_pengabdian_model->view_luaran($id)->result_array();
        $this->load->view('admin/settings/view', $data);
    }

    public function edit_luaran($id)
    {
        $data = $this->Luaran_lain_pengabdian_model->get_luaran($id);
    ...
    public function update_status()
    {
        ...
        $this->Luaran_lain_pengabdian_model->update_luaran($id, $data);
        echo json_encode(array("status" => TRUE));
    }
    ...
    public function delete()
    {
        ...
        $this->Luaran_lain_pengabdian_model->delete_luaran($id, 'tbl_luaran_lain');
        $data['status'] = TRUE;
        echo json_encode($data);
    }
