...
class HKI_penelitian extends MY_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(array('HKI_penelitian_model', 'Data_dosen_model', 'Tipe_pengajuan_model', 'akses_model'));
    }
    ...
    public function index()
    {
        ...
        if ($view_level == 'Y') {
            return $this->template->load('admin/layouts/layoutbackend', 'admin/kinerja_penelitian/HKI_penelitian', $data);
        } else {
